...
///
/// Replace the placeholder values with the configuration from the Firebase
/// console. The structure matches the file generated by `flutterfire configure`
/// so it can be swapped out easily when real values are available.
